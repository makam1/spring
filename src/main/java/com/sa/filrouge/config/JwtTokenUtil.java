package com.sa.filrouge.config;
...
//   compaction of the JWT to a URL-safe string
    private String doGenerateToken(Map<String, Object> claims, String subject) throws Exception {
        Utilisateur user= userRepository.findByUsername(subject).orElseThrow();
        ...
        if(user.getStatut().equals("actif")==false || user.getPartenaire().getStatut().equals("actif")==false){
            String message="Vous êtes bloqué, veuillez contacter votre administrateur";
            return message;
        }
